...
def gridplot(*args, **kwargs):
    ...
    if toolbar_location == 'above':
        return Column(children=[toolbar, grid], rows={0: "min"}, spacing=0, sizing_mode=sizing_mode)
    elif toolbar_location == 'below':
        return Column(children=[grid, toolbar], rows={1: "min"}, spacing=0, sizing_mode=sizing_mode)
    elif toolbar_location == 'left':
        return Row(children=[toolbar, grid], cols={0: "min"}, spacing=0, sizing_mode=sizing_mode)
    elif toolbar_location == 'right':
        return Row(children=[grid, toolbar], cols={1: "min"}, spacing=0, sizing_mode=sizing_mode)
